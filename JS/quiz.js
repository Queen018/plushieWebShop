...
function yours() {
    for (let i = 0; i < jsonData.length; i++) {
        if (rating == jsonData[i].id) {
            ...
            container.innerHTML = `<div class="PlushieContainer p-1">
                                    ...
                                    <div>
                                        ...
                                        <div class="">
                                            <button class="btnBgText" onclick="itemsInCart('${jsonData[i].name}', '${jsonData[i].image}', '${jsonData[i].price}', 1), addedAlert('${jsonData[i].name}', '${jsonData[i].image}');">Toevoegen</button>
                                        </div>
                                    </div>
...
function displayQuizQ1() {
    const container = document.getElementById("quizContainer");
    container.innerHTML = `<div class="quizQuestion">
...
function displayQuizQ2() {
    ...
    container.innerHTML = `<div class="quizQuestion">
                            ...
                            <div class="row text-center gx-3 gy-2 m-1">
                                <div class="col-md-6 col-lg">
                                    <button class="buttonPrevious p-1 bg-secondary" onclick="displayQuizQ1(), ratingAmount(0);">Previous</button>
                                </div>
                            </div>`;
}
...
function displayQuizQ3() {
    ...
    container.innerHTML = `<div class="quizQuestion">
                            ...
                            <div class="row text-center gx-3 gy-2 m-1">
                                <div class="col-md-6 col-lg">
                                    <button class="buttonPrevious p-1 bg-secondary" onclick="displayQuizQ2(), ratingAmount(0);">Previous</button>
                                </div>
                            </div>`;
}
...
function displayQuizQ4() {
    ...
    container.innerHTML = `<div class="quizQuestion">
                            ...
                            <div class="row text-center gx-3 gy-2 m-1">
                                <div class="col-md-6 col-lg">
                                    <button class="buttonPrevious p-1 bg-secondary" onclick="displayQuizQ3(), ratingAmount(0);">Previous</button>
                                </div>
                            </div>`;
}
...
function displayQuizQ5() {
    ...
    container.innerHTML = `<div class="quizQuestion">
                            ...
                            <div class="row text-center gx-3 gy-2 m-1">
                                <div class="col-md-6 col-lg">
                                    <button class="buttonPrevious p-1 bg-secondary" onclick="displayQuizQ4(), ratingAmount(0);">Previous</button>
                                </div>
                            </div>`;
}
